	...
	while(option_choice)
	{
    	...
    	switch(option_choice)
    	{
    		...
    		case 3:	color_data_nilv_raw = ReadPpmPicColor(&w, &h);
    				...
    				WriteJlsColorNoIlvPic(color_data_nilv_encoded, w, h, bitstream_size);
    		...
    		case 4:	color_data_silv_raw = ReadPpmPicColor(&w, &h);
    				...
    				WriteJlsColorSampleIlvPic(color_data_silv_encoded, w, h, bitstream_size[0]);
    		...
    		case 5:	gray_data_jls = ReadJlsPicGray(&w, &h, bitstream_size);
    				...
    				WritePgmPic(gray_data_decoded, w, h);
    				Free1D(gray_data_jls);
    				Free2D(gray_data_decoded);
    				gray_data_jls = NULL;
    				gray_data_decoded = NULL;
    		case 6:	color_data_lilv_jls = ReadJlsPicColorLineIlv(&w, &h, bitstream_size);
			...
			case 7:	color_data_nilv_jls = ReadJlsPicColorNoIlv(&w, &h, bitstream_size);
					...
					WritePpmPic(color_data_nilv_decoded, w, h);
					...
					break;		
			case 8: color_data_silv_jls = ReadJlsPicColorSampleIlv(&w, &h, bitstream_size);
					...
					WritePpmPic(color_data_silv_decoded, w, h);
