...
HD_PWD='C:/Users/Dawid/Desktop/JPEG-LS/JPEG-LS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_ans.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_ans.tcl
